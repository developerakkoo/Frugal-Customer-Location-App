...
@Component({
  selector: 'app-bulldozer',
  templateUrl: './bulldozer.page.html',
  styleUrls: ['./bulldozer.page.scss'],
})
export class BulldozerPage implements OnInit {
  ...
  getAllAutos() {
    this.http.get("https://consign-612af-default-rtdb.firebaseio.com/bulldozer.json").subscribe((autos: any) => {
      console.log(autos);
