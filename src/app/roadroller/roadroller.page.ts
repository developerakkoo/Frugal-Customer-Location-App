...
@Component({
  selector: 'app-roadroller',
  templateUrl: './roadroller.page.html',
  styleUrls: ['./roadroller.page.scss'],
})
export class RoadrollerPage implements OnInit {
  ...
  getAllAutos() {
    this.http.get(environment.URL+`/vehicles/nearMe/${this.lat}/${this.lng}/ROADROLLER`)
    .subscribe({
      next:(autos:any) =>{
