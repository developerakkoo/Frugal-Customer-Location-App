...
@Component({
  ...
  templateUrl: './tractor.page.html',
  styleUrls: ['./tractor.page.scss'],
})
export class TractorPage implements OnInit {
  ...
  getAllAutos() {
    this.http.get(environment.URL+`/vehicles/nearMe/${this.lat}/${this.lng}/TRACTOR`)
    .subscribe({
      next:(autos:any) =>{
